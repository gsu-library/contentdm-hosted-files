...
- Add module showing accessibility statement on items with a tag of TitleIIArchival.

### Changed

- Update esbuild to v0.28.0.

## [1.12.0] - 2026-03-31

- Add custom HTML page titled accessibility.
...
- Update esbuild to v0.27.2.

## [1.11.0] - 2026-01-20

- Add faqs.html and help.html to custom pages.
- Update and add FAQs/answers on faqs.html.
